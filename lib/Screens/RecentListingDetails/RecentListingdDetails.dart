                  ...
                  child: controller.listofrecentListings.isEmpty
                      ...
                      : Column(
                          ...
                          children: [
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  InkWell(
                                    onTap: () async {
                                      launchURL(
                                          "whatsapp://send?phone=${controller.listofrecentListings[0]['cell_number']}"); // ew lin
                                    },
                                    child: Container(
                                      height: height * 0.060,
                                      width: width * 0.120,
                            ...
                            controller.listofrecentListings[0]['payment_mod'] ==
                                        '' ||
                                    controller.listofrecentListings[0]
                                            ['payment_mod'] ==
                                        null
                                                      ...
                                                      children: [
                                                        ...
                                                        Row(
                                                          children: [
                                                            ...
                                                            Text(
                                                              '${double.parse('${controller.listoflistingsProduct[i]['total_review']}').toInt().toString()} ' +
                                                                  'reviews'.tr,
                                                              style: TextStyle(
                                                                  fontSize: 10),
                                                            ),
                                ...
                                Get.to(SearchDetails(
                                  buisinessId:
                                      controller.listofProductServices[index]
                                          ['service_id'],
                                  fromApi: 'service',
                                  b_ID: controller.listofProductServices[index]
                                      ['b_id'],
                                  name:
