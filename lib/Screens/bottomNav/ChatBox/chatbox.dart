                                ...
                                child: Container(
                                  ...
                                  child: Theme(
                                      data: new ThemeData(
                                          ...
                                          hintColor: Colors.black),
                                      child: DropdownButton<String>(
                                        items: controller.listofCat.map((
                                            value) {
                                          return DropdownMenuItem<String>(
                                            value: '$value',
                                            child:
      ...
      children: <Widget>[
        ...
        decoration: BoxDecoration(
            ...
            image: DecorationImage(
                fit: BoxFit.cover,
                image: NetworkImage(
                    'https://www.dailboxx.websitescare.com/upload/industry/${widget
                        .mapData!['industy_sub_name_image']}'))),
      ),
      SizedBox(
        width: 15,
      ),
      ...
      children: <Widget>[
        ...
        decoration: BoxDecoration(
            ...
            image: DecorationImage(
                fit: BoxFit.cover,
                image: NetworkImage(
                    'https://www.dailboxx.websitescare.com/upload/profile/${widget
                        .mapData!['profile_image']}'))),
      ),
      SizedBox(
        width: 15,
      ),
      Expanded(
        child: Column(
          ...
          children: <Widget>[
            ...
            Text(
              '${widget.mapData!['main_cat_name'] ?? ''} > ${widget
