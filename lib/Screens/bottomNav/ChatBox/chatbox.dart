                  ...
                  child: Obx(
                        ...
                        RefreshIndicator(
                          onRefresh: () async {
                            ...
                            controller.currentlistofCatIndex.value = 0;
                            controller.listofCatHint.value = 'Category';
                            await ApiUtils.getgetDiscussionform(
                                controller: controller);
                          },
                            ...
                            slivers: [
                                ...
                                child: Padding(
                                  ...
                                  child: Column(
                                    children: [
                                      ...
                                      TextFormField(
                                        cursorColor: Colors.black,
                                        controller: controller.writeCommentCon
                                            .value,
                                        textAlign:
                                        findLanguageController.isEnglishLocale
                                            .value
                                            ? TextAlign.left
                                            : TextAlign.right,
                                        keyboardType: TextInputType.text,
                                          ...
                                          InkWell(
                                            onTap: () async {
                                              if (controller
                                                  ...
                                                  .value !=
                                                  'Select Industry'.tr) {
                                                if (controller.listofCatHinttwo
                                                    .value !=
                                                    'Category'.tr) {
                                                  if (controller.writeCommentCon
                                                      .value
                                                      .text.isNotEmpty) {
                                                    ...
                                                    controller.f1.value =
                                                        File('path');
                                                    controller.loadmainList
                                                        .value =
                                                    false;
                                                    ApiUtils
                                                        .getgetDiscussionform(
                                                        controller: controller);
                                                  } else {
                                                    snackBarFailer(
                              ...
                              !controller.loadmainList.value
                                ...
                                delegate: SliverChildBuilderDelegate(
                                    ...
                                    print(
                                        'total length = ${controller
                                            .listofChatBox.length}');
                                    return Column(
                                      children: [
                                        ChatBoxItem2(
                                          mapData:
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      '${widget.mapData!['industy_name']} > ${widget
                          .mapData!['industy_sub_name']}',
                  ...
                  children: <Widget>[
                    Row(
                      children: <Widget>[
                        ...
                        Text(
                          '${widget.mapData!['date_time'].toString().split(
                              ' ')[0]}' +
                              '  $time',
                          style: TextStyle(color: greyColor, fontSize: 8),
                        ),
                    ...
                    Text(
                      '${widget.mapData!['industry_name'] ?? ''} > ${widget
                          .mapData!['main_cat_name']}',
                      style: TextStyle(color: greyColor, fontSize: 10),
                    ),
                  ],
                ),
          ...
          Container(
            child: Row(
              ...
              children: <Widget>[
                InkWell(
                  onTap: () {
                    if ('${widget.controller!.listofChatBox[widget
                        .index!]['islike']}' ==
                        'false') {
                      print('like');
                      ApiUtilsForAll.getlikeDiscussionform(
                          form_id:
                          '${widget.controller!.listofChatBox[widget
                              .index!]['discussion_id']}',
                          index: widget.index,
                          controller: widget.controller,
                          isLike: true)
